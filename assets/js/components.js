  ...
  connectedCallback() {
    this.innerHTML = `
        <nav class="navbar navbar-expand-lg bg-body-tertiary fixed-top py-0">
          <div class="navbar-section container-fluid py-2 px-4">
            ...
            <p id="nav-phone" class="ps-4 m-auto"><i class="fa-solid fa-phone"></i> 123-456-7890</p>
            <p id="nav-email" class="ps-4 m-auto"><a class="text-decoration-none text-dark" href="mailto:test@caribourentals.com"><i class="fa-solid fa-envelope"></i> test@caribourentals.com</a></p>
...
class SuccessMessage extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `    
      <div class="text-center m-auto pt-2" id="success">
        <i class="fa-regular fa-circle-check fa-10x pb-2" style="color: #81D959;"></i>
        <h4 class="pt-4">Form submitted successfully!</h3>
          <p class="text-base text-center text-gray-400">Thank you! We have received your message and will get back to you
            soon!</p>
      </div>
      `;
  }
...
class FailureMessage extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `    
      <div class="text-center pt-2" id="failure">
        <i class="fa-regular fa-circle-check fa-10x pb-2" style="color: #81D959;"></i>
        <h4 class="pt-4">Form submitted successfully!</h3>
          <p class="text-base text-center text-gray-400">Thank you! We have received your message and will get back to you
            soon!</p>
...
class Footer extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `    
      <footer class="bg-light m-auto py-5 container-fluid mt-5">
...
class Loading extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `    
      <button class="btn btn-primary" id="form-submit-button" type="submit" style="width: 100%;">
...
customElements.define('failure-message', FailureMessage);
